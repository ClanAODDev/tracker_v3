...
new _vue2.default({
    ...
    components: { DonutGraph: _DonutGraph2.default }
});

},{"./components/DonutGraph":28,"vue":26}],28:[function(require,module,exports){
"use strict";
...
exports.default = _vue2.default.extend({
    ...
    methods: {
        render: function render(data, options) {
            var chart = new Chart(this.$els.canvas.getContext('2d')).Doughnut(data, options);
        }
    }
});
