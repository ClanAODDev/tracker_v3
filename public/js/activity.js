...
var _DonutGraph = require("./components/DonutGraph");

var _DonutGraph2 = _interopRequireDefault(_DonutGraph);

var _DonutGraphWithLegend = require("./components/DonutGraphWithLegend");

var _DonutGraphWithLegend2 = _interopRequireDefault(_DonutGraphWithLegend);
...
new _vue2.default({
    ...
    components: {
        DonutGraph: _DonutGraph2.default,
        DonutGraphWithLegend: _DonutGraphWithLegend2.default
    }
});

},{"./components/DonutGraph":5,"./components/DonutGraphWithLegend":6,"vue":3}],5:[function(require,module,exports){
"use strict";
...
exports.default = _vue2.default.extend({
    ...
    methods: {
        render: function render(data, options) {
            var chart = new Chart(this.$els.canvas.getContext('2d')).Pie(data, options);
        }
    }
});
