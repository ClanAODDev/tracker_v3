    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('last_voice_activity')->label('Last Discord VoIP')->since(),
                Tables\Columns\TextColumn::make('last_activity')->label('Last Forum Activity')->since(),
            ])
            ->filters([
                //
            ])
