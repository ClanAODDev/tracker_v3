<div class="panel panel-filled panel-c-danger collapsed">
    ...
    <div class="panel-body">
        <p><span class="text-warning">WARNING:</span> Deleting a division should only be done as a last resort. If you wish simply to deactivate the division (for instance, if the division is shut down), you should deselect the "active" option instead of deleting it. </p>
