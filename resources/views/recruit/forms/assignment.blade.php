...
@else
    <div class="panel panel-filled panel-c-danger">
        ...
        <div class="panel-body">
            <p><i class="fa fa-exclamation-triangle text-danger"></i> Your division has no {{ str_plural($division->locality('platoon')) }}, so assignment is not unavailable. A division leader will need to create one.</p>
        </div>
    </div>
@endif
