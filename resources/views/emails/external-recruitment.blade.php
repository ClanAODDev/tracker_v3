...
<p>{{ $recruiter->name}} from {{ $recruiter->primaryDivision->name }} recently recruited a member into your division, so we thought we'd let you know the details so you can follow up.</p>
<p>
