...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <p>Twig makes use of three types of syntax: <code>@{{ output statements }}</code>,
            <code>{% control structures %}</code>, and <code>{# comments #}</code>. Output statements are used to echo strings, like name, or rank abbreviation, or position name. Control structures allow you to iterate over items, or operate on conditionals. An example of this would be:
        </p>
