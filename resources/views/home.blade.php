...
<div class='panel panel-default'>
	...
	<div class='list-group'>
		...
		<a href='divisions/{{ $division->abbreviation }}' class='list-group-item' style='padding-bottom: 18px;'>
			<span class='pull-left' style='margin-right: 20px; vertical-align: middle;'><img class="img-responsive" src='images/game_icons/48x48/{{ $division->abbreviation }}.png' /></span>
			<h4 class='list-group-item-heading hidden-xs hidden-sm'><strong>{{ $division->name }} Division</strong></h4><h4 class='list-group-item-heading hidden-md hidden-lg' style="margin:10px 0;"><strong>{{ $division->abbreviation }} Division</strong></h4>
