<div class="panel panel-filled panel-c-danger collapsed">
    ...
    <div class="panel-body">
        <span class="text-warning">WARNING:</span> Deleting this {{ $division->locality('squad') }} will permanently remove it from your division. Any assigned members will be automatically unassigned, and will need to be reassigned to a new {{ $division->locality('squad') }}.
    </div>
