<div class="panel panel-filled panel-c-danger collapsed">
    ...
    <div class="panel-body">
        <p>
            <span class="text-warning">WARNING:</span> Deleting this {{ $division->locality('platoon') }} will permanently remove it from your division. Any assigned members will be automatically unassigned, and will need to be reassigned to a new platoon.
        </p>
