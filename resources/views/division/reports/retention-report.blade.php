    ...
    <script>
      !function (r) {
        ...
        function e (r) {
          ...
          return o.sort(function (r, o) {return r[0] - o[0];}), o;
        }
        ...
        function s (r, o, e) {i(o, 'xaxis', e), i(o, 'yaxis', e);}

        r.plot.plugins.push({
          init: function (r) {r.hooks.processRawData.push(o), r.hooks.processDatapoints.push(s);},
