        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <p>AOD provides several consumable APIs which are intended solely for internal community use. AOD data,
                    ...
                    nor used
                    for any other purpose. Any questions regarding the usage of AOD data or API tokens should be
                    directed to
                    clan leadership.</p>

                <p><strong class="text-danger">Misuse of these resources will result in revocation of access, and could
                        lead to
