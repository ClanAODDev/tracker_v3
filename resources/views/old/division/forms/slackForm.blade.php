            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <span class="help-block"><small>Enter the webhook URL you wish to post updates to. Left blank, the Tracker will default to the <a
                                    href="http://clanaod.slack.com" target="_blank">AOD Slack</a>.</small></span>
                </div>
                <div class="form-group">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="material-switch pull-right">
                                ...
                                <input id="slack_alert_removed_member" name="slack_alert_removed_member"
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="material-switch pull-right">
                                ...
                                <input id="slack_alert_updated_member" name="slack_alert_updated_member"
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="material-switch pull-right">
                                ...
                                <input id="slack_alert_created_request" name="slack_alert_created_request"
