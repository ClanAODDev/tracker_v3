			...
			<table class='table table-striped table-hover'>
				<table class='table table-striped table-hover'>
					...
					<?php foreach($daily as $player) : ?>
						<tr data-id='<?php echo $player->member_id ?>'><td class='text-center text-muted'><small><?php echo $i; $i++ ?></small></td><td><strong><?php echo $player->rank ?> <?php echo $player->forum_name;?></strong></td><td class='text-center text-muted'><?php echo ordSuffix($player->plt); ?> Platoon</td><td><strong><?php echo $player->aod_games ?></strong></td></tr>
					<?php endforeach; ?>
