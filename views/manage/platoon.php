			...
			<div class="col-xs-8">
				<div class="row">
					...
					<?php foreach ($squads as $squad): ?>
						...
						<div class="col-xs-6">
							<h3 class="page-header squad-header"><span class="hidden-xs hidden-sm"><?php echo ordsuffix($i); ?> <?php echo Locality::run('Squad', $division->id); ?> </span><small><?php echo $leader_name ?></small> <a href="#" class="btn btn-xs btn-default modify-squad" style="position: absolute; left: 15px;"><i class="fa fa-wrench"></i> Edit Squad</a><span class="badge pull-right"><?php echo count((array)$members); ?></span></h3>
