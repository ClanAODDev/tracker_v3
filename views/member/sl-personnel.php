<?php if ($member->position_id == 5) : ?><!-- if squad leader -->
	<?php if (Squad::count($memberInfo->member_id)) : ?>
		<div class='panel panel-primary'>
			<div class='panel-heading'><strong><?php echo $memberInfo->forum_name ?>'s Squad</strong> <span class="pull-right"><?php echo Squad::count($memberInfo->member_id); ?> members</span></div>
